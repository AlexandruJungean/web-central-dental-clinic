  ...
  return (
    <section className="relative section-padding overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[800px] px-6 md:px-10">
        <ScrollReveal>
          <p className="mb-4 text-center text-[13px] font-medium uppercase tracking-premium text-gray-subtle">
            Rezultate reale
          </p>
          <h2 className="text-center font-serif text-3xl font-light text-foreground md:text-5xl">
            Transformări reale
          </h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.15}>
          <div className="mt-14">
            <div className="relative overflow-hidden">
              <div className="grid grid-cols-2 gap-px bg-gray-separator">
                <ImagePlaceholder
              ...
              <div className="absolute inset-y-0 left-1/2 flex -translate-x-1/2 items-center">
                <div className="flex h-10 w-10 items-center justify-center rounded-full border border-foreground/20 bg-white/80 backdrop-blur-sm">
                  <svg className="h-4 w-4 text-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <p className="mt-6 text-center text-sm text-gray-subtle">
