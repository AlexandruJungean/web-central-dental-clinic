...
export const TEAM = {
  ...
  assistants: [
    { name: "Ioana", role: "Asistentă", image: "/images/echipa/Ioana%20-%20transparent.webp" as string | null },
    { name: "Naomi", role: "Asistentă", image: "/images/echipa/Naomi%20-%20transparent.webp" as string | null },
    { name: "Maria", role: "Asistentă", image: "/images/echipa/Maria%20-%20transparent.webp" as string | null },
  ],
} as const;
